...
const columns = [
    ...
    { id: 'code', label: 'موضوع', minWidth: 100 ,align: 'right',},
    { id: 'name', label: 'شماره تیکت', minWidth: 170 ,align: 'right',},
];
...
export default function Ticket() {
    ...
    console.log("Ticket")
    return (
        <Box position="fixed"  display="flex" justifyContent="center" alignItems="center" height="100vh"   sx={{
            width: '100%',
                ...
                <Paper sx={{ width: '100%', overflow: 'hidden' ,borderRadius:"20px",bgcolor:"#F4F4F4",boxShadow:3}}>
                   <Box display="flex" justifyContent="space-between">
                       {isXsScreen && (
                           ...
                           >
                               <Link to={"/panel/chat"} sx={{textDecoration:"none"}}>
                               افزودن
                               </Link>
                           </Button>
                       )}
