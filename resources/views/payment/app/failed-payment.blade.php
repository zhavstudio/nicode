...
<div class="card">
    ...
    <a class="button-33" href="{{env('VITE_APP_URL')}}/panel/financial" id="timerButton">انتقال به اپلیکیشن تا 10 ثانیه</a>
</div>
<script>
    ...
    function updateButtonText() {
        ...
        timerButton.textContent = ` انتقال به اپلیکیشن تا${remainingSeconds}ثانیه`;
